...
export default async function AdminNuevoDistribuidorPage() {
  ...
  return (
    <div id="admin-nuevo-distribuidor-root" className="min-h-screen bg-neutral-50 text-neutral-900 flex flex-col justify-between p-4 md:p-8">
      <div className="max-w-7xl mx-auto w-full space-y-8">
        ...
        <main className="space-y-6">
          ...
          <div className="flex items-center gap-2 text-xs text-neutral-500">
            ...
            <span>/</span>
            <span className="text-neutral-900 font-semibold">Nuevo</span>
          </div>

          <DistribuidorForm distribuidorInicial={null} />
        </main>
      </div>

      <footer className="max-w-7xl mx-auto w-full py-6 text-center text-xs text-neutral-400 border-t border-neutral-200 mt-12">
        Portal Profesional Steffen • Alta de Distribuidor
      </footer>
    </div>
  );
}
